...
class Layout extends Model
  @attribute('expanded', class extends attribute.CollectionAttribute
    default: -> new List()
  )
  ...
  @transient('computed')
  @bind('computed', from('context').and('context').watch('panels').and('expanded').and('minimized').all.flatMap((context, panels, expanded, minimized) ->
